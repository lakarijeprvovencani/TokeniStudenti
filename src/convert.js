...
const MODEL_INPUT_LIMITS = {
  ...
  'claude-opus-4-7':   { tokens: 900000, chars: 2700000 },  // 1M context - 128K max output.
                                                             // Same 900K token budget as Sonnet 4.6
                                                             // (leaves 100K headroom for tools +
                                                             // adaptive-thinking output), but the
                                                             // char budget is ~25% tighter because
                                                             // the new 4.7 tokenizer can consume up
                                                             // to 35% more tokens per text. A fresh
                                                             // estimate: ~3 chars/token effective
                                                             // vs ~4 chars/token on 4.6.
  // Legacy
