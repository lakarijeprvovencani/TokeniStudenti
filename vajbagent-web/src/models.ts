...
export const MODELS: Model[] = [
  ...
  { id: 'vajb-agent-turbo',     name: 'Turbo',     desc: 'Claude Haiku — brz, jeftin, precizan' },
  { id: 'vajb-agent-pro',       name: 'Pro',       desc: 'Ozbiljniji projekti, jak i pametan' },
  { id: 'vajb-agent-max',       name: 'Max',       desc: 'Claude Sonnet — najbolji balans za sajtove', tag: 'Preporučeno' },
